...
📦 **Скачать APK**: [TerminalFree-v1.3.5.apk](https://github.com/Flawl3ssss/terminal-free/releases/download/v1.3.5/TerminalFree-v1.3.5.apk)
...
- **Сортировка и поиск в «Files»**: по имени, дате и размеру — папки
  ...
  или вставку пути.
- **Встроенный браузер**: лёгкий WebView с щипковым зумом, открывается на

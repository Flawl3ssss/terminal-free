...
📦 **Скачать APK**: [TerminalFree-v1.3.4.apk](https://github.com/Flawl3ssss/terminal-free/releases/download/v1.3.4/TerminalFree-v1.3.4.apk)
...
- **Путь файла в строку ввода**: кнопка «＋» в доп. клавишах терминала
  открывает обзор `/workspace` (папки первыми, затем по алфавиту); по тапу
  на файл его путь вставляется в текущую строку ввода сессии.

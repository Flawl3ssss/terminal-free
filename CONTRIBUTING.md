# Contributing to Terminal Free

Thanks for considering contributing to Terminal Free. This document covers how to build the project, run it, and get your changes merged.
